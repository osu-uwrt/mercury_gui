...
private:
    ...
    // times for stamping
    rclcpp::Time lastDiag, lastKill, lastZed, lastLeak, lastCpuTemp, stbdlastBattery,
        portlastBattery;
    bool diagsTimedOut, killTimedOut, zedTimedOut, leakTimedOut, cpuTempTimedOut,
        stbdBatteryTimedOut, portBatteryTimedOut;
