...
//
// mercury_rviz srv client utility. Handles calls to services without blocking the ui with feedback
// to the user.
//
...
public:
    ...
    typedef std::function<void(
        const std::string &, typename rclcpp::Client<SrvType>::SharedResponse)>
        ResponseFunc;
    ...
    void callService(typename SrvType::Request::SharedPtr request) {
        ...
        updateStatus(
            QString("Waiting for service %1").arg(QString::fromStdString(srvName)), "000000");
