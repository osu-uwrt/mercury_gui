#include "riptide_rviz/DiagnosticsPanel.hpp"
...
namespace riptide_rviz
{
    ...
    bool DiagnosticsPanel::event(QEvent *event)
    { 
...
PLUGINLIB_EXPORT_CLASS(riptide_rviz::DiagnosticsPanel, rviz_common::Panel);